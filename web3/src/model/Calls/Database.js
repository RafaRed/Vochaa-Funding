import { server, createcontest_path, gettasks_path, updatepullrequests_path, getpullrequests_path, gettask_path, getpullrequest_path, getvotes_path, sendvotes_path, getpullrequestvotes_path } from "../repository";
